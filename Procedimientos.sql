...
--Para probar
--EXECUTE AgregarAlumno @Nombre='H�CTOR',@Sexo='M',@Apellido='GORDILLO',@DNI=111,@Provincia=11,@Localidad=26,@Direccion='General Viamonte 1658',@FechaNac='2008-4-2',@Anio=1,@Division='1'
...
BEGIN
	...
	WHILE @@FETCH_STATUS = 0
	BEGIN
		/*Primero borramos los registros de la tabla Alumno_Nota para evitar el error por restricci�n de FK*/
